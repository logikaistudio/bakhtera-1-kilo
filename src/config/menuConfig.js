...
export const APP_MENUS = {
    ...
    Blink: {
        ...
        menus: [
            ...
            { code: 'blink_auto_journal', label: 'Auto Jurnal (12 bulan)', group: 'Finance', path: '/blink/finance/auto-journal' },
            { code: 'blink_reversing_journal', label: 'Reversing Jurnal', group: 'Finance', path: '/blink/finance/reversing-journal' },
            { code: 'blink_journal', label: 'Jurnal Umum', group: 'Finance', path: '/blink/finance/general-journal' },
            { code: 'blink_noted_journal', label: 'Jurnal Noted (Audit)', group: 'Finance', path: '/blink/finance/noted-journal' },
