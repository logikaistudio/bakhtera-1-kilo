        ...
        try {
            const [{ data: accounts }, { data: entries }] = await Promise.all([
                ...
                supabase.from('bridge_journal_line_items')
                    ...
                    .lte('bridge_journal_entries.entry_date', asOf),
            ]);
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div>
                    <h1 className="text-3xl font-bold gradient-text flex items-center gap-2">
                        <BarChart2 className="w-8 h-8" /> Balance Sheet — Bridge
                    </h1>
                    <p className="text-silver-dark mt-1">Neraca keuangan Bridge module</p>
                </div>
