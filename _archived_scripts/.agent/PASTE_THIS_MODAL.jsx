// ============================================================================
// PASTE THIS CODE at line 1490 (AFTER the warehouse selector closing })
// BEFORE: </div >
// Location: /src/pages/Bridge/PengajuanManagement.jsx
// ============================================================================
                            ...
                            <div key={pkgIndex} className="glass-card p-4 rounded-lg border border-dark-border">
                                <div className="flex items-center justify-between mb-3 pb-2 border-b border-dark-border">
                                    <div>
                                        ...
                                        <p className="text-xs text-silver-dark mt-1">{activeItems.length} item dipilih</p>
                                    </div>
                                </div>
...
// ============================================================================
// END OF MODAL - Make sure this is BEFORE the </div > on line 1491
// ============================================================================
