...
-- Migration: 20260127_create_role_permissions_table.sql
...
-- Create policy for authenticated users to read role permissions
...
-- Create policy for super admin to manage role permissions
